                ...
                <div className="row">
                    <div className="col-4">
                        <div className="card bg-white border-0 mt-2 p-2">
                            ...
                            <h3 className="mx-3">Количество доната</h3>
                            <div className="range">
                                <div className="lines1"></div>
                                <div className="circles1 salom"></div>
                                <div className="lines2 salom"></div>
                                <div className="circles2 salom"></div>
                                <div className="lines3"></div>
                            </div>
                            <div className="count">
                                <div className="d-flex align-items-center">
                            ...
                            <h3 className="mx-3">Тип аккаунта</h3>
